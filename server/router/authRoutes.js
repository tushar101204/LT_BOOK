...
router.get('/getuser', auth, authController.getallInstructor);
router.delete('/deleteuser/:userID', auth, authController.deleteFaculty);
...
router.post('/contact', auth, authController.contact);
